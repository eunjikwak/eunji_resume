  ...
  list: [
      ...
      descriptions: [
        {
          ...
          weight: 'MEDIUM',
          descriptions: [
            { content: '기존의 데스크톱 중심 웹사이트를 다양한 기기에서 최적화된 사용자 경험을 제공하도록 개발' },
        ...
        },
        {
          ...
          descriptions: [
            ...
            { content: 'Nodemailer를 사용해 안정적이고 빠른 이메일 전송을 구현하고, 서버의 성능에 영향을 주지 않도록 비동기 처리로 최적화' }
          ],
        },
        {
    ...
    },
    {
      ...
      descriptions: [
        {
          content:
            '브랜딩 및 캐릭터 디자인 신규 서비스 홈페이지 개발',
          weight: 'MEDIUM',
          descriptions: [
            { content: '사용자가 웹사이트를 통해 직접 문의를 보낼 수 있도록 Nodemailer를 사용해 이메일 송신 기능 개발' },
      ...
      descriptions: [
        {
          ...
          weight: 'MEDIUM',
          descriptions: [
            { content: '기존의 데스크톱 중심 웹사이트를 다양한 기기에서 최적화된 사용자 경험을 제공하도록 리뉴얼' },
            { content: 'HTML, CSS, JavaScript, React 사용하여 반응형 웹 디자인 구현' },
          ],
        },
        {
          content:
            '포트폴리오 페이지 추가 및 관리 기능 개발',
          weight: 'MEDIUM',
          descriptions: [
            { content: '포트폴리오 페이지를 통해 잠재 고객의 관심을 유도' },
        ...
        },
        {
          ...
          weight: 'MEDIUM',
          descriptions: [
            { content: '초기에는 Naver Cloud Console을 사용해 배포했으나, 서비스 확장성과 유지보수 효율성을 고려하여 Vercel로 전환' },
            { content: '전환 후 서버 안정성을 크게 개선하고, 다운타임을 최소화하여 사용자 경험을 향상' },
      ...
      descriptions: [
        {
          ...
          weight: 'MEDIUM',
          descriptions: [
            { content: '협업회사에서 제공한 디자인을 기반으로 다양한 기기에서 최적화된 반응형 웹사이트 구현' },
      ...
      descriptions: [
        ...
        },
        {
          ...
          descriptions: [
            ...
            { content: '서울여자간호대학교 메타버스 (서울여자간호대) - 응급실 시뮬레이션 방탈출 제작' },
        ...
        },
        {
          ...
          descriptions: [
            ...
            { content: '탄소중립센터메타버스 (포항시탄소중립지원센터) - 나무심기, 자전거게임, 분리수거게임' },
